...
public class MainPage extends BasePage {
    ...
    public void sendLetter(Mail mail) {
        ...
        driver.findElement(inputWriteAddressLocator).sendKeys(mail.getUsername());
        driver.findElement(inputWriteTitleLocator).sendKeys(mail.getSubject());
        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
        driver.findElement(inputWriteBodyLocator).sendKeys(mail.getUsername());
        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
